...
func (m *EncryptedMessage) signingPayload(senderPublicKeys *identity.UserPublic, receiverPublicKeys *identity.UserPublic, senderSessionID, receiverSessionID []byte) ([]byte, error) {
	var b bytes.Buffer
